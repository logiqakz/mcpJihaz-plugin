...
> **Если вы впервые открыли ChatGPT:** этот GitHub-репозиторий не даёт установку одной кнопкой в ChatGPT Web. Это технический пакет для администраторов и пользователей клиентов с импортом плагинов. Для обычного мебельщика нужна готовая общедоступная карточка в каталоге ChatGPT или отдельный готовый сервис с входом по ссылке. Инструкция ниже предназначена тому, кто настраивает подключение.
